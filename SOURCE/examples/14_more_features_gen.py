...
print(words)
txt = "hello world"
print(txt.replace("world", "killer"))
print("=== ARRAY METHODS ===")
def double(x):
    return (x * 2)
...
nums = KillerArray([1, 2, 3])
doubled = nums.map(double)
print(doubled)
sum = KillerArray([1, 2, 3, 4]).reduce(add_acc, 0)
print(sum)
arr = KillerArray(["a", "b", "c"])
print(arr.join("-"))
unsorted = KillerArray([3, 1, 4, 1, 5])
print(unsorted)
arr2 = KillerArray([1, 2, 3])
print(arr2)
arr3 = KillerArray([1, 2, 3, 4, 5])
removed = arr3.splice(1, 2, 10, 20)
print("Removed:")
print(removed)
print("After splice:")
print(arr3)
print("=== ARRAY.isArray ===")
print(Array.isArray(KillerArray([1, 2, 3])))
print(Array.isArray("not an array"))
print(Array.isArray(42))